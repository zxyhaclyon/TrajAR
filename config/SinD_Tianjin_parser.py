...
def AddModelArgs(parser):
    ...
    parser.add_argument("--mtp_num_layers", default=2 , type=int)
    ...
    parser.add_argument("--esa_num_layers", default=4, type=int)
    ...
    parser.add_argument("--TrajAR_num_layers", default=4, type=int)
...
def AddDataArgs(parser):
    ...
    parser.add_argument("--data_root", default='./data/SinD-Tianjin', type=str)

    parser.add_argument("--dataset", default='SinD-Tianjin', type=str)
